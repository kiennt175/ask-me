            ...
            <div class="col-md-8">
                <div class="page-content ask-question">
                    ...
                    <div class="form-style form-style-3" id="question-submit">
                        <form action="{{ route('questions.update', $question->id) }}" method="post" id="update-question" enctype="multipart/form-data">
                            @csrf
							<div class="form-inputs clearfix">
								<p>
									<label class="required">Question Title<span>*</span></label>
									<input type="text" id="question-details" name="title" value="{{ $question->title }}" required autocomplete="off">
									<span class="form-description">Please choose an appropriate title for the question to answer it even easier.</span>
								</p>
								<p>
									<label class="required">Tags<span>*</span></label>
									<input type="text" class="input" value="{{ $tags }}" name="tags" id="question_tags" data-seperator=",">
