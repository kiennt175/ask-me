					...
					<div class="user-profile">
						<div class="col-md-12">
							<div class="page-content">
								...
								@endif
								<span style="float: left; margin-top: -55px; margin-left: 200px;">{{ $user->username ? '(@' . $user->username . ')' : ''}}</span>
								<b>{{ $user->bio }}</b>
								<p></p>
								...
								<div class="ul_list ul_list-icon-ok about-user">
									<ul>
										...
										<li><i class="icon-group"></i>Followers: <span>xxx</span></li>
							...
							<div class="page-content page-content-user-profile">
								<div class="user-profile-widget">
									...
									<div class="ul_list ul_list-icon-ok">
										<ul>
											<li><i class="icon-question-sign"></i><a href="{{ route('user.newsfeedBy', $user->id) }}">Questions<span> ( <span>{{ $user->questions->count() }}</span> ) </span></a></li>
											<li><i class="icon-comment"></i><a href="user_answers.html">Answers<span> ( <span>{{ $user->answers->count() }}</span> ) </span></a></li>
											<li><i class="icon-star"></i><a href="user_favorite_questions.html">Saved Questions<span> ( <span>xxx</span> ) </span></a></li>
											<li><i class="icon-heart"></i><a href="user_points.html">Points<span> ( <span>{{ $user->points }}</span> ) </span></a></li>
											<li><i class="icon-asterisk"></i>Best Answers<span> ( <span>xxx</span> ) </span></li>
										</ul>
									</div>
								</div>
							</div>
